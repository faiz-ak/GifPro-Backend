...
def generate_gif():
    ...
    logger.info(f"Received request - mode: {mode}, files: {len(uploaded_files)}, speed: {speed_multiplier}")
    ...
    try:
        if mode == 'photo':
            ...
            out.seek(0)
            logger.info("Photo GIF generated successfully")
            ...
            logger.info("Writing final GIF output")
